...
class ClientPrefs {
	...
	public static var framerate:Int = 64;
	...
	public static var timeTxt:Bool = false;
	public static var ratingsEnabled:Bool = false;
	public static var useDodgeMechanic:Bool = true;
	public static var useHeartMechanic:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.timeTxt = timeTxt;
		FlxG.save.data.ratingsEnabled = ratingsEnabled;
		FlxG.save.data.useDodgeMechanic = useDodgeMechanic;
		FlxG.save.data.useHeartMechanic = useHeartMechanic;
		...
		save.bind('controls_v2', '.bakugo/FallenAngels/ninjamuffin99'); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.timeTxt != null) {
			timeTxt = FlxG.save.data.timeTxt;
		}
		if(FlxG.save.data.ratingsEnabled != null) {
			ratingsEnabled = FlxG.save.data.ratingsEnabled;
		}
		if(FlxG.save.data.useDodgeMechanic != null) {
			useDodgeMechanic = FlxG.save.data.useDodgeMechanic;
		}
		if(FlxG.save.data.useHeartMechanic != null) {
			useHeartMechanic = FlxG.save.data.useHeartMechanic;
		}
		...
		var save:FlxSave = new FlxSave();
		save.bind('controls_v2', '.bakugo/FallenAngels/ninjamuffin99');
